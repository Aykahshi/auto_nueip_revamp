                      ...
                      child: Padding(
                        ...
                        child: addressJoker.perform(
                          builder: (context, companyAddress) {
                            ...
                            return presenter.focusOn<bool>(
                              selector: (state) => state.isGpsClockInEnabled,
                              builder: (context, isGpsEnabled) {
                                return Column(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  children: <Widget>[
                                    // --- Address Warning Section --- (Conditional display based on Joker state)
                                    if (!isAddressSet && !isGpsEnabled)
                                      Card(
                                            color: context
                                                .colorScheme
                                                .errorContainer
                                    ...
                                    >(
                                      selector: (state) => (
                                        ...
                                        state.details,
                                        state.activeAction,
                                        state.isGpsClockInEnabled,
                                      ),
                                      builder: (context, data) {
                                        final status = data.$1;
                                        final details = data.$2;
                                        final activeAction = data.$3;
                                        final isGpsEnabled = data.$4;
                                    ...
                                    Padding(
                                      ...
                                      child: presenter
                                          .focusOn<(bool, bool, String?)>(
                                            ...
                                            builder: (context, data) {
                                              final isGpsEnabled = data.$1;
                                              final isGpsLoading = data.$2;
                                    ...
                                    // --- Time Cards Display ---
                                    presenter.focusOn<
                                      (ClockTimeStatus, DailyClockDetail?)
                                    >(
                                      selector: (state) =>
                                          (state.timeStatus, state.details),
                                      builder: (context, data) {
